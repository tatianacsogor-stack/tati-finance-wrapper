...
4. If your GitHub repository contains the whole finance project, set **Root Directory** to:
...
6. Deploy.
7. Open the deployed Vercel URL on your iPhone in Safari.
8. Tap **Share** -> **Add to Home Screen**.

## Fixing A Vercel 404

If Vercel shows `404 This page could not be found`, the most common cause is that Vercel deployed the parent folder instead of this wrapper folder.
